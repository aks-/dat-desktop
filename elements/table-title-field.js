...
TitleField.prototype.createElement = function (props) {
  ...
  if (state.isEditing && state.writable) this.renderActive()
...
TitleField.prototype.renderInactive = function () {
  ...
  function onclick (e) {
    ...
    this.createElement(Object.assign({}, this.props))
  }
}
...
TitleField.prototype.renderActive = function () {
  ...
  function handleSave (e) {
    ...
    this.props.emit('dats:update-title', { key: self.state.key, title: self.state.editValue })
    deactivate()
  }
